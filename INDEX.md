...
```javascript
// content.js funciona em 3 partes:
...
### Arquivo Principal
- **`extension/content.js`** (~180 linhas)
  - Lógica de injeção e captura
  - Listeners de mensagens Chrome
...
```javascript
// Usuário clica em "Enviar" na popup
// ↓
// Popup envia: chrome.tabs.sendMessage({ type: 'INJECT_MESSAGE', message: 'Olá!', messageId: '123' })
// ↓
// Content script injeta "Olá!" no ChatGPT
// ↓
// Content script clica o botão de envio
// ↓
// Content script aguarda resposta (30s timeout)
// ↓
// Resposta capturada e enviada de volta à popup
```
